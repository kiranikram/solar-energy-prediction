...
df = df[['day', 'month', 'hour', 'minute', 'sin_day', 'cos_day', 'sin_month', 'cos_month', 'sin_hour', 'cos_hour', 'sin_min', 'cos_min', 'Total']]
...
df.to_csv(os.path.join(PATH, '..\\' 'data', 'sunrock_clean_pe_april.csv'), index=False)
